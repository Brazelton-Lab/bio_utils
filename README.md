...
returning lines of a file as dictionaries. screed is used for reading FASTA and
...
incorrectly formatted, a description of what the error is printed. All
scripts in verifiers are also stand-alone programs.
