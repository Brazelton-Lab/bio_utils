...
def sam_verifier(handle, log_file = None):
    ...
    for samEntry in sam_iter(handle):
        entry = '{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t%s{}\t{}\n'.format( \
                samEntry['qname'], samEntry['flag'], samEntry['rname'],\
                samEntry['pos'], samEntry['mapq'], samEntry['cigar'],\
                samEntry['rnext'], samEntry['pnext'], samEntry['tlen'],\
                samEntry['seq'], samEntry['qual'])
        lines.append(entry)
    regex = r'^[!-?A-~]{1,255}\t'\
            + r'([0-9]{1,4}|[0-5][0-9]{4}|'\
            + r'[0-9]{1,4}|[1-5][0-9]{4}|'\
